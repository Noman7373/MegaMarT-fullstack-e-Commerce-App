...
const CartPage = ({ cartPageClose }) => {
  ...
  return (
    <section className="fixed top-0 bottom-0 left-0 right-0 z-40 bg-neutral-800 bg-opacity-40">
      <div className="h-full bg-white max-w-sm w-full  min-h-screen max-h-screen ml-auto rounded">
        ...
        {cart.length > 0 ? (
              ...
              <>
                ...
                <div className="p-2 bg-[#F0F2F7]">
                  <div className="bg-white rounded-xl border p-2">
                    ...
                    <p className="text-slate-400 text-[0.8rem] ml-2 mt-2">
          ...
          <div className="flex flex-col justify-center items-center mt-2">
            <div className="w-full h-full object-scale-down">
              <img src={noProductImage} alt="empty-cart-img" />
            </div>
            <button
              onClick={closeCart}
              className="bg-[#16A34A] hover:bg-[#3ddd77] text-white rounded p-2"
            >
              Shop Now{" "}
            </button>
          </div>
